...
const (
	...
	AuthService_UpdateAuth_FullMethodName = "/auth.AuthService/UpdateAuth"
)
...
type AuthServiceClient interface {
	...
	UpdateAuth(ctx context.Context, in *UpdateAuthRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *authServiceClient) UpdateAuth(ctx context.Context, in *UpdateAuthRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type AuthServiceServer interface {
	...
	UpdateAuth(context.Context, *UpdateAuthRequest) (*emptypb.Empty, error)
...
func (UnimplementedAuthServiceServer) UpdateAuth(context.Context, *UpdateAuthRequest) (*emptypb.Empty, error) {
