...
const (
	...
	ChatService_GetMessagesByChat_FullMethodName = "/chat.ChatService/GetMessagesByChat"
)
...
type ChatServiceClient interface {
	...
	GetChat(ctx context.Context, in *ChatGetRequest, opts ...grpc.CallOption) (*Chat, error)
	GetChatsByUser(ctx context.Context, in *ChatGetByUserRequest, opts ...grpc.CallOption) (*ChatGetByUserResponse, error)
	GetMessagesByChat(ctx context.Context, in *ChatGetRequest, opts ...grpc.CallOption) (*ChatGetMessagesResponse, error)
}
...
func (c *chatServiceClient) CreateChat(ctx context.Context, in *ChatCreateRequest, opts ...grpc.CallOption) (*Chat, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Chat)
...
func (c *chatServiceClient) GetChat(ctx context.Context, in *ChatGetRequest, opts ...grpc.CallOption) (*Chat, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Chat)
...
func (c *chatServiceClient) GetChatsByUser(ctx context.Context, in *ChatGetByUserRequest, opts ...grpc.CallOption) (*ChatGetByUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChatGetByUserResponse)
...
func (c *chatServiceClient) GetMessagesByChat(ctx context.Context, in *ChatGetRequest, opts ...grpc.CallOption) (*ChatGetMessagesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChatGetMessagesResponse)
	err := c.cc.Invoke(ctx, ChatService_GetMessagesByChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	GetChat(context.Context, *ChatGetRequest) (*Chat, error)
	GetChatsByUser(context.Context, *ChatGetByUserRequest) (*ChatGetByUserResponse, error)
	GetMessagesByChat(context.Context, *ChatGetRequest) (*ChatGetMessagesResponse, error)
...
func (UnimplementedChatServiceServer) CreateChat(context.Context, *ChatCreateRequest) (*Chat, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateChat not implemented")
}
func (UnimplementedChatServiceServer) GetChat(context.Context, *ChatGetRequest) (*Chat, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetChat not implemented")
}
func (UnimplementedChatServiceServer) GetChatsByUser(context.Context, *ChatGetByUserRequest) (*ChatGetByUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetChatsByUser not implemented")
}
func (UnimplementedChatServiceServer) GetMessagesByChat(context.Context, *ChatGetRequest) (*ChatGetMessagesResponse, error) {
...
func _ChatService_GetChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetChat(ctx, req.(*ChatGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChatService_GetChatsByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetChatsByUser(ctx, req.(*ChatGetByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChatService_GetMessagesByChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GetMessagesByChat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetMessagesByChat(ctx, req.(*ChatGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
